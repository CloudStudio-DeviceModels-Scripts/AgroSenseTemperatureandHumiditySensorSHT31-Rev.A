...
# Parsing + Configuration Script – AgroSense Temperature and Humidity Sensor_SHT31 - Rev. A

This **Parsing + Configuration** script is designed for the **AgroSense Temperature and Humidity Sensor_SHT31** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AgroSense Temperature and Humidity Sensor_SHT31 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AgroSense Temperature and Humidity Sensor_SHT31** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
